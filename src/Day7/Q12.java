...
public class Q12 {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(2000);
		WebElement flip2= driver.findElement(By.xpath("//span[text()='Baby & Kids']"));
		...
		File destination=new File("C:\\Users\\ADMIN\\eclipse-workspace\\Selenium\\screenshot\\flipkart2.png"+timestamp+".png");
